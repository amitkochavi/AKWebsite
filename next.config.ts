...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      // Home lives at / (Hebrew) and /en (English) — redirect phantom "/home"
      // paths (from old indexes) so they don't 404. (/he/* is handled by the
      // i18n middleware, which strips the default-locale prefix.)
